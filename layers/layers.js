...
lyr_fokotanyamoronimania_2.set('fieldLabels', {'P_CODE': 'no label', 'FOKONTANY_': 'no label', 'FKT_BNGRC_': 'no label', 'C_FKT_BNGR': 'no label', 'COM_PCODE': 'no label', 'C_CODE_BNG': 'no label', 'COMMUNE_NA': 'no label', 'BNGRC_COM_': 'no label', 'DIST_PCODE': 'no label', 'DISTRICT_N': 'no label', 'BNGRC_D_CO': 'no label', 'BNGRC_DIS_': 'no label', 'DIS_FKT': 'no label', 'REG_PCODE': 'no label', 'REGION_NAM': 'no label', 'BNGRC_R_CO': 'no label', 'BNGRC_REG_': 'no label', 'REG_FKT_SH': 'no label', 'PROV_CODE': 'no label', 'OLD_PROVIN': 'no label', 'MILIEU': 'no label', 'OLD_DISTRI': 'no label', 'SOURCE': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'inline label', 'amoroniman': 'no label', });
